...
;
;
BDOS	EQU	000FFH	;BDOS ENTRY TO CP/M
...
;************************************************************
;
OKCPU:	DB	0CH,0DH,0AH,' CPU IS OPERATIONAL!',00H
;
NGCPU:	DB	0CH,0DH,0AH,' CPU HAS FAILED!',00H
;
;
;
;************************************************************
...
;
;
STACK	EQU	127	;DE-BUG STACK POINTER STORAGE AREA
;
;
;
	END
